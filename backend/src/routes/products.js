  ...
  try {
    const product = await prisma.product.findUnique({
      ...
      select: {
        ...
        personalizationNameEnabled: true, personalizationNameMaxLength: true, personalizationNamePrice: true,
        personalizationNumberEnabled: true, personalizationNumberMaxDigits: true, personalizationNumberPrice: true,
        categories: true,
