  ...
  return (
    <form onSubmit={save} className="space-y-6 max-w-3xl">
      ...
      <Section title="🖼️ Banners de Promoção">
        <p className="text-xs text-gray-400 -mt-2">Aparecem em carrossel automático na home. Tamanho ideal: <span className="font-semibold text-gray-600">1280 × 355px</span></p>
